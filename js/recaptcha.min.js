...
function (a) {
    ...
    a.module("vcRecaptcha").provider("vcRecaptchaService", function () {
        ...
        c.onLoadFunctionName = "vcRecaptchaApiLoaded", c.setDefaults = function (b) {
            ...
            function k() {
                if (!l) throw new Error("reCaptcha has not been loaded yet.")
            }
            var l, m = g.defer(),
                n = m.promise,
                o = {};
            ...
            var p = function () {
                l = f.grecaptcha, m.resolve(l)
            };
            if (f.vcRecaptchaApiLoadedCallback.push(p), f[c.onLoadFunctionName] = function () {
                    f.vcRecaptchaApiLoadedCallback.forEach(function (a) {
                        a()
                    })
                }, a.isDefined(f.grecaptcha)) p();
            else if (f.document.querySelector('script[src^="https://www.google.com/recaptcha/api.js"]')) var q = i(function () {
                a.isDefined(f.grecaptcha) && (i.cancel(q), p())
            }, 25);
            else {
                var r = f.document.createElement("script");
                r.async = !0, r.defer = !0, r.src = "https://www.google.com/recaptcha/api.js?onload=" + c.onLoadFunctionName + "&render=explicit", h.find("body")[0].appendChild(r)
            }
            return {
                create: function (a, c) {
                ...
                reload: function (a) {
                    k(), l.reset(a), e.$broadcast("reCaptchaReset", a)
                },
                execute: function (a) {
                    k(), l.execute(a)
                },
